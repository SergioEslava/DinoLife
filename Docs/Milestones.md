...
- [ ] .csproj configurations (NET8, nullable, warnings as errors)
- [ ] .editorconfig with team code style
- [ ] Directory.Build.props for shared properties
- [ ] .gitignore and .gitattributes

#### 1.2 Core Data Structures
- [ ] `Entity` struct with Id, Type, Flags
- [ ] `EntityType` enum (Herbivore, Carnivore, Plant, Scavenger)
- [ ] `ComponentFlags` enum
- [ ] Component structs: `Transform`, `Metabolism`, `Movement`, `Diet`, `Reproduction`
